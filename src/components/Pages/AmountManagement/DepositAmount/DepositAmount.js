...
const DepositAmount = () => {
  ...
  const handleDepositAmount = async (e) => {
    e.preventDefault()
    console.log("Depositing amount for:", accountNumber)
    try {
      setIsLoading(true)
      const response = await fetch(`${API_BASE_URL}/api/accounts/${accountNumber}/deposit`, {
        method: "PATCH",
        headers: {
    ...
    <div className="account-details-container">
      ...
      {accountDetails && !notFound &&(
        ...
        <form className="account-details" onSubmit={handleDepositAmount}>
          ...
          <h5 style={{textAlign: 'left', margin:"0px", padding:"0px"}}>Enter Amount to Deposit</h5>
          ...
          <button className="deposit-button" type="submit">Deposit</button>
